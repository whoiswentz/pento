defmodule PentoWeb.Router do
  ...
  import PentoWeb.Plugs.UserAuth
  ...
  scope "/", PentoWeb do
    ...
    live_session :redirect_if_user_is_authenticated,
      on_mount: [{PentoWeb.Plugs.UserAuth, :redirect_if_user_is_authenticated}] do
  ...
  scope "/", PentoWeb do
    ...
    live_session :require_authenticated_user,
      ...
      on_mount: [{PentoWeb.Plugs.UserAuth, :ensure_authenticated}] do
  ...
  scope "/", PentoWeb do
    ...
    live_session :current_user,
      on_mount: [{PentoWeb.Plugs.UserAuth, :mount_current_user}] do
